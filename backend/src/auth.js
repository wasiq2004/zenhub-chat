...
router.post('/auth/login', async (req, res) => {
  ...
  try {
    ...
    // Secure flag on over HTTPS. Production is always served behind Caddy TLS,
    // so default to secure in production; COOKIE_SECURE=true can force it on
    // elsewhere. (Matches the /auth/setup cookie behavior.)
